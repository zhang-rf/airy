...
public class OrderRequiredSerializer extends ReferencedSerializer implements StructedSerializer {
            ...
            do {
                ...
                for (Field field : fields) {
                    ...
                    if (objectMap.containsKey(value))
                        ...
                        write(buffer, value, referenceType, getGenericTypes(field.getGenericType()));
                    }
                }
        ...
        try {
            ...
            for (Field field : fieldList) {
                ...
                if (addressMap.containsKey(address)) {
                    ...
                    Object value = read(buffer, field.getType(), getGenericTypes(field.getGenericType()));
